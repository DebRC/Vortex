...
GETH_BOOTNODE_PORT=30302

GETH_HTTP_PORT=3000
GETH_WS_PORT=3100
GETH_AUTH_RPC_PORT=3200
GETH_METRICS_PORT=3300
GETH_NETWORK_PORT=3400

PRYSM_BEACON_RPC_PORT=2000
PRYSM_BEACON_GRPC_GATEWAY_PORT=2100
PRYSM_BEACON_P2P_TCP_PORT=2200
PRYSM_BEACON_P2P_UDP_PORT=2300
PRYSM_BEACON_MONITORING_PORT=2400

PRYSM_VALIDATOR_RPC_PORT=5000
PRYSM_VALIDATOR_GRPC_GATEWAY_PORT=5100
PRYSM_VALIDATOR_MONITORING_PORT=5200
...
GETH_BINARY=../eth-testnet/dependencies/go-ethereum/build/bin/geth
GETH_BOOTNODE_BINARY=../eth-testnet/dependencies/go-ethereum/build/bin/bootnode

PRYSM_CTL_BINARY=../eth-testnet/dependencies/prysm/bazel-bin/cmd/prysmctl/prysmctl_/prysmctl
PRYSM_BEACON_BINARY=../eth-testnet/dependencies/prysm/bazel-bin/cmd/beacon-chain/beacon-chain_/beacon-chain
PRYSM_VALIDATOR_BINARY=../eth-testnet/dependencies/prysm/bazel-bin/cmd/validator/validator_/validator
...
for (( i=0; i<$NUM_NODES; i++ )); do
    ...
    taskset -c $((2*LAYER1_NUM_NODES + NUM_NODES + i)) $PRYSM_BEACON_BINARY \
      ...
      --contract-deployment-block=0 --chain-id=${CHAIN_ID:-32383} \
    ...
    taskset -c $((2*LAYER1_NUM_NODES + NUM_NODES + i)) $PRYSM_VALIDATOR_BINARY \
